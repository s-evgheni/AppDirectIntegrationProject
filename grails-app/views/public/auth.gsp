...
<sec:ifLoggedIn>
    <p>You are logged in as <sec:loggedInUserInfo field="username"/></p>
    <sec:access expression="hasRole('ROLE_USER')">
        <g:link controller='secured' action='users'>click here to login</g:link>
    </sec:access>
    <sec:access expression="hasRole('ROLE_ADMIN')">
        <g:link controller='secured' action='admins'>click here to login</g:link>
    </sec:access>
</sec:ifLoggedIn>
<script>
